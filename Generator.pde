...
class Randomizer {
    ...
    GrafOBJ generate() {
     ...
     if(randShape == -1) randShape = int(random(0,24));
     else {
       side = 1;
       col = 5;
       int rs = randShape;
       while(rs == randShape) {
         randShape = int(random(0,24));
       }
    ...
    case 1:
      return Generator.generate(new StarShape(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
      
    case 2:
      return Generator.generate(new Merkaba(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    
    case 3:
      return Generator.generate(new Octahedron(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
     
    case 4:
      return Generator.generate(new Heart(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
     
    case 5:
      return Generator.generate(new Tetrahedron(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
      
    case 6:
      return Generator.generate(new SuperShape(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    ...
    case 14:
      return Generator.generate(new Veneric(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 15:
      return Generator.generate(new Mars(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 16:
      return Generator.generate(new Trans(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 17:
      return Generator.generate(new Smile(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 18:
      return Generator.generate(new HavaNagila(), side*300, -150, 10, 60, 0.1, 200, 0.1, 50, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 19:
      return Generator.generate(new SuperShape3D1(), side*300, -150, 10, 60, 0.1, 200, 0.1, 90, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 20:
      return Generator.generate(new SuperShape3D2(), side*300, -150, 10, 60, 0.1, 200, 0.1, 90, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 21:
      return Generator.generate(new SuperShape3D3(), side*300, -150, 10, 60, 0.1, 200, 0.1, 90, color(colors[col],100,100), 0, 0, 0, 0, 0.008, 0.002);
    case 22:
